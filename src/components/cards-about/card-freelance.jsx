    ...
    <Card className="min-h-[500px] w-full max-w-[850px] bg-[#3674B5]">
      <CardHeader className="flex items-center justify-center gap-2 pt-6">
        ...
        <p className="jersey-10-regular text-xl text-white sm:text-2xl md:text-[41px]">
          {t('sessionAbout.cards.freelance.title')}
        </p>
      </CardHeader>
      <CardContent className="cabin-regular w-full px-4 text-sm text-white md:px-15 md:text-lg">
        <div className="flex w-full justify-center gap-2">
          <Star size={20} className="text-white" />
          <h2 className="jersey-10-regular pb-4 text-2xl text-white">
            {t('sessionAbout.cards.freelance.subtitle')}
          </h2>
        </div>
        <div className="flex w-full flex-wrap justify-center gap-2">
          <Badge className="h-[40px] bg-white px-4 text-sm font-bold text-[#3674B5] shadow-lg">
            {t('sessionAbout.cards.freelance.badge1')}
          </Badge>
          <Badge className="h-[40px] bg-white px-4 text-sm font-bold text-[#3674B5] shadow-lg">
            {t('sessionAbout.cards.freelance.badge2')}
          </Badge>
          <Badge className="h-[40px] bg-white px-4 text-sm font-bold text-[#3674B5] shadow-lg">
            {t('sessionAbout.cards.freelance.badge3')}
          </Badge>
          <Badge className="h-[40px] bg-white px-4 text-sm font-bold text-[#3674B5] shadow-lg">
            {t('sessionAbout.cards.freelance.badge4')}
          </Badge>
          <Badge className="h-[40px] bg-white px-4 text-sm font-bold text-[#3674B5] shadow-lg">
            {t('sessionAbout.cards.freelance.badge5')}
          </Badge>
        </div>
        ...
        <div className="mt-8 flex w-full flex-col gap-2 rounded-lg border-2 border-dashed border-[#3674B5] bg-[#ffffff80] p-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold text-white">
              {t('sessionAbout.cards.freelance.availability.title')}
            </h2>
          </div>
          <p className="cabin-regular text-sm text-[##6B4F4F] md:text-lg">
            {t('sessionAbout.cards.freelance.availability.description')}
          </p>
        </div>
      </CardContent>
    </Card>
